...
client = pyM.MongoClient('mongodb://localhost:27017/?readPreference=primary&appname=MongoDB%20Compass&ssl=false')
...
result = "[ObjectId('64487dc9d227208165676a65'), ObjectId('64487dc9d227208165676a66')]"
...
# user_profile = [{'user_id':211,'author':'Tiago1'},{'user_id':212,'author':'Tiago2'},{'user_id':213,'author':'Tiago3'}]
